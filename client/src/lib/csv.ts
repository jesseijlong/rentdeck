...
const COLUMNS: { key: keyof Property; header: string }[] = [
  ...
  { key: "downPayment", header: "Down Payment" },
  { key: "loanAmount", header: "Loan Amount" },
  { key: "loanBalance", header: "Loan Balance" },
  { key: "interestRate", header: "Interest Rate %" },
  { key: "mortgagePayment", header: "Mortgage Payment" },
  ...
  return rows.map((r) => {
    ...
    for (const [k, v] of Object.entries(r)) {
      ...
      const numericKeys: (keyof Property)[] = [
        "purchasePrice", "currentValue", "downPayment", "loanAmount", "loanBalance",
        "interestRate", "mortgagePayment", "monthlyRent", "otherIncome", "vacancyRate",
        "propertyTaxes", "insurance", "maintenance", "hoa", "propertyManagement",
        "utilities", "capexReserve", "otherExpenses",
      ];
